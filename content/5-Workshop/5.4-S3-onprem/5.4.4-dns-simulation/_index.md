...
![hosted zone](/fck-workshop/images/5-Workshop/5.4-S3-onprem/hosted-zone.png)

2. Create a new record in the Private Hosted Zone:

![Create record](/fck-workshop/images/5-Workshop/5.4-S3-onprem/create-record1.png)
...
![record1](/fck-workshop/images/5-Workshop/5.4-S3-onprem/record1.png)
...
![record 2](/fck-workshop/images/5-Workshop/5.4-S3-onprem/record2.png)

The new records appear in the Route 53 console:

![result](/fck-workshop/images/5-Workshop/5.4-S3-onprem/result.png)
...
![Inbound endpoint](/fck-workshop/images/5-Workshop/5.4-S3-onprem/route53-1.png)

3. Copy the two IP addresses listed to your text editor

![Ip addresses](/fck-workshop/images/5-Workshop/5.4-S3-onprem/route53-2.png)

4. From the Route 53 menu, choose **Resolver** > **Rules**, and click **Create rule**:

![Ip addresses](/fck-workshop/images/5-Workshop/5.4-S3-onprem/route53-3.png)
...
![create rule](/fck-workshop/images/5-Workshop/5.4-S3-onprem/route53-4.png)

+ VPC: VPC On-prem
+ Outbound endpoint: VPCOnpremOutboundEndpoint

![create rule](/fck-workshop/images/5-Workshop/5.4-S3-onprem/route53-5.png)

+ Target IP Addresses: Enter both IP addresses from your text editor (inbound endpoint addresses) and then click Submit

![create rule](/fck-workshop/images/5-Workshop/5.4-S3-onprem/route53-6.png)
You have successfully created resolver forwarding rule. 

![create rule](/fck-workshop/images/5-Workshop/5.4-S3-onprem/route53-7.png)

#### Test the on-premises DNS Simulation

1. Connect to **Test-Interface-Endpoint EC2 instance** with **Session manager**

![create rule](/fck-workshop/images/5-Workshop/5.4-S3-onprem/test1.png)
...
![create rule](/fck-workshop/images/5-Workshop/5.4-S3-onprem/dig.png)
...
![create rule](/fck-workshop/images/5-Workshop/5.4-S3-onprem/subnet.png)
...
![create rule](/fck-workshop/images/5-Workshop/5.4-S3-onprem/endpoint.png)

5. Terminate your Session Manager session:

![create rule](/fck-workshop/images/5-Workshop/5.4-S3-onprem/terminal.png)
