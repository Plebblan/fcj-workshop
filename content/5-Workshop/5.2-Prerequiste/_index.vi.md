...
Trong lab này, chúng ta sẽ dùng Singapore region (ap-southeast-1).
...
![create stack](/fcj-workshop/images/5-Workshop/5.2-Prerequisite/create-stack1.png)

+ Lựa chọn 2 mục acknowledgement 
+ Chọn Create stack

![create stack](/fcj-workshop/images/5-Workshop/5.2-Prerequisite/create-stack2.png)
